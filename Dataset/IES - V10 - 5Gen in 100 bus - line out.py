...
'''  Data set for 100 random single line outage  '''
...
psspy.dyre_new([1,1,1,1],r"""C:\IEEE118.dyr""","","","")
...
for index, line in enumerate(lines_to_disable):
    ...
    lines_to_disable2 = random.sample(line_list, 4)
    # Disable the selected lines
    for line2 in lines_to_disable2:
        psspy.dist_branch_trip(line2[0], line2[1], r"""1""")
